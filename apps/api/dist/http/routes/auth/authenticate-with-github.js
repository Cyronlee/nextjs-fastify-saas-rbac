...
var authenticate_with_github_exports = {};
__export(authenticate_with_github_exports, {
  authenticateWithGitHub: () => authenticateWithGitHub
});
module.exports = __toCommonJS(authenticate_with_github_exports);
...
// src/http/routes/auth/authenticate-with-github.ts
async function authenticateWithGitHub(app) {
  app.withTypeProvider().post(
    ...
    async (request, reply) => {
      ...
      const { access_token: GitHubAccessToken } = import_zod3.z.object({
      ...
      const {
        ...
        id: import_zod3.z.coerce.number().int().transform(String),
        avatar_url: import_zod3.z.string().url(),
...
//# sourceMappingURL=authenticate-with-github.js.map