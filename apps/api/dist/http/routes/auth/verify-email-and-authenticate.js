...
var verify_email_and_authenticate_exports = {};
__export(verify_email_and_authenticate_exports, {
  verifyEmailAndAuthenticate: () => verifyEmailAndAuthenticate
});
module.exports = __toCommonJS(verify_email_and_authenticate_exports);
...
// src/http/routes/auth/verify-email-and-authenticate.ts
async function verifyEmailAndAuthenticate(app) {
  app.withTypeProvider().post(
    ...
    async (request, reply) => {
      ...
      const tokenWasCreatedAt = (0, import_dayjs.default)(validationToken.createdAt);
...
0 && (module.exports = {
  verifyEmailAndAuthenticate
});
//# sourceMappingURL=verify-email-and-authenticate.js.map