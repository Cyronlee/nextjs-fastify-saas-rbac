  ...
  app.withTypeProvider().register(auth).put(
    "/organization/:slug/projects/:projectId",
    {
      schema: {
        ...
        params: import_zod11.default.object({
          ...
          projectId: import_zod11.default.string().uuid()
        }),
    ...
    async (request, reply) => {
      ...
      if (cannot("update", authProject)) {
        throw new UnauthorizedError(errors2.projects.CANNOT_UPDATE);
      }
      ...
      if (existsAnotherProjectWithSameSlug && existsAnotherProjectWithSameSlug.id !== project.id) {
        throw new BadRequestError(errors2.projects.ALREADY_EXISTS);
      }
