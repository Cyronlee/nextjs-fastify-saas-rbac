    ...
    "/organization/:organizationSlug/projects/:projectSlug",
    {
      schema: {
        ...
        params: import_zod11.default.object({
          organizationSlug: import_zod11.default.string(),
          projectSlug: import_zod11.default.string()
        }),
        response: {
          200: import_zod11.default.object({
            project: import_zod11.default.object({
              ...
              ownerId: import_zod11.default.string().uuid().nullable(),
              owner: import_zod11.default.object({
                id: import_zod11.default.string().uuid(),
