...
var leave_organization_exports = {};
__export(leave_organization_exports, {
  leaveOrganization: () => leaveOrganization
});
module.exports = __toCommonJS(leave_organization_exports);
...
// src/http/routes/account/leave-organization.ts
async function leaveOrganization(app) {
    ...
    "/users/organizations/:organization",
    {
      schema: {
        ...
        params: import_zod.default.object({
          organization: import_zod.default.string()
        }),
        response: {
          200: import_zod.default.null()
        }
      }
    },
    async (request, reply) => {
...
//# sourceMappingURL=leave-organization.js.map