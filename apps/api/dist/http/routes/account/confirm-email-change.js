...
var confirm_email_change_exports = {};
__export(confirm_email_change_exports, {
  confirmEmailChangeToken: () => confirmEmailChangeToken
});
module.exports = __toCommonJS(confirm_email_change_exports);
...
// src/http/routes/account/confirm-email-change.ts
async function confirmEmailChangeToken(app) {
    ...
    "/users/email",
    {
      schema: {
        ...
        body: import_zod.default.object({
          code: import_zod.default.string().uuid()
        })
      }
    },
    async (request, reply) => {
