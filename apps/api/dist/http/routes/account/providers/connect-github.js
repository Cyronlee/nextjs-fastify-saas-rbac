...
var connect_github_exports = {};
__export(connect_github_exports, {
  connectGitHub: () => connectGitHub
});
module.exports = __toCommonJS(connect_github_exports);
...
// src/http/routes/account/providers/connect-github.ts
async function connectGitHub(app) {
  app.withTypeProvider().register(auth).post(
    ...
    async (request, reply) => {
      ...
      const { id: githubId } = import_zod3.z.object({
...
//# sourceMappingURL=connect-github.js.map