  ...
  app.withTypeProvider().register(auth).get(
        ...
        response: {
          200: import_zod2.z.object({
            user: import_zod2.z.object({
              ...
              avatarUrl: import_zod2.z.string().nullable(),
              passwordHash: import_zod2.z.boolean(),
              accounts: import_zod2.z.array(
    ...
    async (request, reply) => {
      ...
      if (hasAnEmailChangePending) {
        const tokenWasCreatedAt = (0, import_dayjs.default)(hasAnEmailChangePending.createdAt);
