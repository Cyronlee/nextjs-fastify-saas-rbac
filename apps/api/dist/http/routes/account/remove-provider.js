...
var remove_provider_exports = {};
__export(remove_provider_exports, {
  removeAccountProvider: () => removeAccountProvider
});
module.exports = __toCommonJS(remove_provider_exports);
...
// src/http/routes/account/remove-provider.ts
async function removeAccountProvider(app) {
