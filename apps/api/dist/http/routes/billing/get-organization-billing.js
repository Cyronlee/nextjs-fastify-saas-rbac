...
var get_organization_billing_exports = {};
__export(get_organization_billing_exports, {
  getOrganizationBilling: () => getOrganizationBilling
});
module.exports = __toCommonJS(get_organization_billing_exports);
...
// src/http/routes/billing/get-organization-billing.ts
async function getOrganizationBilling(app) {
      ...
      schema: {
        ...
        response: {
          200: import_zod11.default.object({
            billing: import_zod11.default.object({
              seats: import_zod11.default.object({
                amount: import_zod11.default.coerce.number(),
                unit: import_zod11.default.coerce.number(),
                price: import_zod11.default.coerce.number()
              }),
              projects: import_zod11.default.object({
                amount: import_zod11.default.coerce.number(),
                unit: import_zod11.default.coerce.number(),
                price: import_zod11.default.coerce.number()
              }),
              total: import_zod11.default.coerce.number()
            })
          })
        }
      }
...
//# sourceMappingURL=get-organization-billing.js.map