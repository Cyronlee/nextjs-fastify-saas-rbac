...
var reject_invite_exports = {};
__export(reject_invite_exports, {
  rejectInvite: () => rejectInvite
});
module.exports = __toCommonJS(reject_invite_exports);
    ...
    "/invites/:inviteId/reject",
    {
      schema: {
        ...
        params: import_zod.default.object({
          inviteId: import_zod.default.string().uuid()
        }),
        response: {
...
//# sourceMappingURL=reject-invite.js.map