...
var get_pending_invites_exports = {};
__export(get_pending_invites_exports, {
  getPendingInvites: () => getPendingInvites
});
module.exports = __toCommonJS(get_pending_invites_exports);
...
async function getPendingInvites(app) {
  app.withTypeProvider().register(auth).get(
    ...
    async (request) => {
      ...
      if (!user) {
        throw new BadRequestError(errors2.user.NOT_FOUND);
      }
...
//# sourceMappingURL=get-pending-invites.js.map