...
var transfer_organization_exports = {};
__export(transfer_organization_exports, {
  transferOrganization: () => transferOrganization
});
module.exports = __toCommonJS(transfer_organization_exports);
...
function createEnv(opts) {
  ...
  const client = (0, import_zod11.object)(_client);
  const server = (0, import_zod11.object)(_server);
  const shared = (0, import_zod11.object)(_shared);
...
var env = createEnv2({
  server: {
    DATABASE_URL: import_zod12.z.string(),
    PORT: import_zod12.z.coerce.number().default(3333),
    JWT_SECRET_KEY: import_zod12.z.string(),
    JWT_PUBLIC_KEY: import_zod12.z.string(),
    GITHUB_OAUTH_CLIENT_ID: import_zod12.z.string(),
    GITHUB_OAUTH_CLIENT_SECRET: import_zod12.z.string(),
    GITHUB_OAUTH_CLIENT_REDIRECT_URI: import_zod12.z.string().url(),
    GITHUB_OAUTH_CLIENT_SCOPE: import_zod12.z.string().default("user"),
    GOOGLE_OAUTH_CLIENT_ID: import_zod12.z.string(),
    GOOGLE_OAUTH_CLIENT_SECRET: import_zod12.z.string(),
    GOOGLE_OAUTH_CLIENT_REDIRECT_URI: import_zod12.z.string().url(),
    GOOGLE_OAUTH_CLIENT_RESPONSE_TYPE: import_zod12.z.string().default("code"),
    GOOGLE_OAUTH_CLIENT_SCOPE: import_zod12.z.string().default("https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile"),
    MAIL_SMTP_HOST: import_zod12.z.string().default("smtp.gmail.com"),
    MAIL_SMTP_PORT: import_zod12.z.coerce.number().default(465),
    MAIL_SMTP_EMAIL: import_zod12.z.string(),
    MAIL_SMTP_PASSWORD: import_zod12.z.string(),
    CLOUDFLARE_ACCOUNT_ID: import_zod12.z.string(),
    CLOUDFLARE_ENDPOINT: import_zod12.z.string(),
    CLOUDFLARE_BUCKET: import_zod12.z.string(),
    CLOUDFLARE_REGION: import_zod12.z.string().default("auto"),
    CLOUDFLARE_ACCESS_KEY: import_zod12.z.string(),
    CLOUDFLARE_SECRET_KEY: import_zod12.z.string()
  },
  client: {},
  shared: {
    NEXT_PUBLIC_URL: import_zod12.z.string().url(),
    NEXT_PUBLIC_API_URL: import_zod12.z.string().url(),
    NEXT_PUBLIC_CLOUDFLARE_URL: import_zod12.z.string()
  },
  runtimeEnv: {
    ...
    "/organizations/:slug/owner",
    {
      schema: {
        ...
        params: import_zod13.default.object({
          slug: import_zod13.default.string()
        }),
        body: import_zod13.default.object({
          transferToUserId: import_zod13.default.string().uuid(),
          action: import_zod13.default.enum(["UPDATE_ROLE", "LEAVE"])
        }),
        response: {
          204: import_zod13.default.null()
        }
      }
    },
    async (request, reply) => {
      ...
      if (cannot("transfer_ownership", authOrganization)) {
        throw new UnauthorizedError(
          errors2.organizations.entity.CANNOT_TRANSFER
        );
      }
      ...
      if (!transferToMembership) {
        throw new BadRequestError(errors2.organizations.entity.NOT_MEMBER);
      }
      ...
      try {
        ...
        throw new BadRequestError(errors2.services.SEND_EMAIL);
      }
...
//# sourceMappingURL=transfer-organization.js.map