...
var get_organization_exports = {};
__export(get_organization_exports, {
  getOrganization: () => getOrganization
});
module.exports = __toCommonJS(get_organization_exports);
      ...
      schema: {
        ...
        response: {
          200: import_zod.default.object({
            organization: import_zod.default.object({
              id: import_zod.default.string().uuid(),
              slug: import_zod.default.string(),
              name: import_zod.default.string(),
              domain: import_zod.default.string().nullable(),
              domainValidationId: import_zod.default.string().uuid().nullable(),
              domainValidatedAt: import_zod.default.date().nullable(),
              shouldAttachUsersByDomain: import_zod.default.boolean(),
              avatarUrl: import_zod.default.string().nullable(),
              createdAt: import_zod.default.date(),
              updatedAt: import_zod.default.date(),
              ownerId: import_zod.default.string().uuid()
            })
          })
        }
      }
