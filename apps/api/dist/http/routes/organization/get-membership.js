...
var get_membership_exports = {};
__export(get_membership_exports, {
  getMemebership: () => getMemebership
});
module.exports = __toCommonJS(get_membership_exports);
...
// src/http/routes/organization/get-membership.ts
async function getMemebership(app) {
      ...
      schema: {
        ...
        response: {
          200: import_zod11.default.object({
            membership: import_zod11.default.object({
              id: import_zod11.default.string().uuid(),
              role: rolesSchema,
              organizationId: import_zod11.default.string().uuid(),
              userId: import_zod11.default.string().uuid()
            })
          })
        }
      }
...
//# sourceMappingURL=get-membership.js.map