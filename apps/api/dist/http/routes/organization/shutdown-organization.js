...
var shutdown_organization_exports = {};
__export(shutdown_organization_exports, {
  shutdownOrganization: () => shutdownOrganization
});
module.exports = __toCommonJS(shutdown_organization_exports);
    ...
    async (request, reply) => {
      ...
      if (cannot("delete", authOrganization)) {
        throw new UnauthorizedError(
          errors2.organizations.entity.CANNOT_SHUTDOWN
        );
      }
...
//# sourceMappingURL=shutdown-organization.js.map