...
var update_organization_exports = {};
__export(update_organization_exports, {
  updateOrganization: () => updateOrganization
});
module.exports = __toCommonJS(update_organization_exports);
  ...
  app.withTypeProvider().register(auth).put(
    ...
    async (request, reply) => {
      ...
      if (cannot("update", authOrganization)) {
        throw new UnauthorizedError(errors2.organizations.entity.CANNOT_UPDATE);
      }
      ...
      if (organizationNameAlreadyExists) {
        throw new BadRequestError(errors2.organizations.entity.ALREADY_EXISTS);
      }
