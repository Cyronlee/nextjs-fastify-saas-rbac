...
var authorize_domain_exports = {};
__export(authorize_domain_exports, {
  authorizeDomain: () => authorizeDomain
});
module.exports = __toCommonJS(authorize_domain_exports);
...
async function authorizeDomain(app) {
    ...
    "/organization/:slug/domain",
    {
      schema: {
        ...
        body: import_zod.default.object({
          domain: import_zod.default.string(),
          shouldAttachUsersByDomain: import_zod.default.boolean().optional()
        }),
        response: {
          204: import_zod.default.null()
        }
      }
    },
    async (request, reply) => {
...
//# sourceMappingURL=authorize-domain.js.map